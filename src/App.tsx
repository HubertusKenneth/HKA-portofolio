...
import { Moon, Sun, Phone, Mail, MapPin, Lightbulb, MessageCircle, Users, Handshake } from 'lucide-react';
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                <a href="#home" className="text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 px-3 py-2 rounded-md text-sm font-medium transition-colors">Home</a>
                <a href="#about" className="text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 px-3 py-2 rounded-md text-sm font-medium transition-colors">About</a>
                <a href="#experience" className="text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 px-3 py-2 rounded-md text-sm font-medium transition-colors">Experience</a>
                <a href="#education" className="text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 px-3 py-2 rounded-md text-sm font-medium transition-colors">Education</a>
                <a href="#skills" className="text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 px-3 py-2 rounded-md text-sm font-medium transition-colors">Skills</a>
                <a href="#contact" className="text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 px-3 py-2 rounded-md text-sm font-medium transition-colors">Contact</a>
              </div>
            </div>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <h2 className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-6 fade-in-on-scroll">Computer Science Student</h2>
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl fade-in-on-scroll">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start fade-in-on-scroll">
                <a href="#contact" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-medium transition-colors">
                  Get In Touch
                </a>
                <a href="#about" className="border border-blue-600 text-blue-600 dark:text-blue-400 dark:border-blue-400 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-400 dark:hover:text-gray-900 px-8 py-3 rounded-lg font-medium transition-colors">
                  Learn More
                </a>
              </div>
            </div>
            <div className="flex justify-center lg:justify-end fade-in-on-scroll">
              <div className="relative">
                <img 
                  src="/image.png" 
                  alt="Hubertus Kenneth Alfragisa" 
                  className="w-80 h-80 md:w-96 md:h-96 rounded-full object-cover shadow-2xl border-4 border-blue-600 dark:border-blue-400"
                />
              </div>
            </div>
          </div>
      ...
      <section id="about" className="py-20 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 fade-in-on-scroll">
              <div className="flex items-center justify-center md:justify-start space-x-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-8">
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md fade-in-on-scroll">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400 mt-2 md:mt-0">2021</span>
                </div>
              ...
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md fade-in-on-scroll">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400 mt-2 md:mt-0">2022</span>
                </div>
              ...
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md fade-in-on-scroll">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400 mt-2 md:mt-0">2024 - Present</span>
                </div>
              ...
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md fade-in-on-scroll">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400 mt-2 md:mt-0">2025 - Present</span>
                </div>
      ...
      <section id="education" className="py-20 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-md fade-in-on-scroll">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">2023 - Present</p>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-md fade-in-on-scroll">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">2020 - 2023</p>
      ...
      <section id="skills" className="py-20 bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md text-center fade-in-on-scroll">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="text-center fade-in-on-scroll">
                ...
                <a href="mailto:hubertus.alfragisa@binus.ac.id" className="text-blue-600 dark:text-blue-400 hover:underline">
              ...
              <div className="text-center fade-in-on-scroll">
                ...
                <a href="tel:+62083890403193" className="text-blue-600 dark:text-blue-400 hover:underline">
                  +62 083890403193
                </a>
              </div>
            ...
            <div className="text-center bg-gray-50 dark:bg-gray-800 p-8 rounded-lg fade-in-on-scroll">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Connect with me</h3>
              <div className="flex justify-center space-x-6">
                <a href="https://instagram.com/hubertus.kenneth" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-blue-600 dark:bg-blue-500 rounded-lg flex items-center justify-center text-white hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors">
                ...
                <a href="https://linkedin.com/in/hubertus-kenneth-alfragisa" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-blue-600 dark:bg-blue-500 rounded-lg flex items-center justify-center text-white hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="mailto:hubertus.alfragisa@binus.ac.id" className="w-12 h-12 bg-blue-600 dark:bg-blue-500 rounded-lg flex items-center justify-center text-white hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors">
